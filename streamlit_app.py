...
st.markdown("Добро пожаловать в приложение для просмотра расписания занятий! Используйте фильтры слева, чтобы выбрать нужные параметры, и нажмите 'Показать расписание'. Мы надеемся, что это приложение сделает ваш учебный процесс удобнее и организованнее.")
